...
## Overview
This notebook applies a linear Kalman filter to real GPS trajectories from the Microsoft GeoLife dataset. Two motion models are implemented and compared: Constant Velocity (CV) and Constant Acceleration (CA).
